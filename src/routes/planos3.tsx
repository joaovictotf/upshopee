...
export const Route = createFileRoute("/planos3")({ component: PlanosPage });
...
const LINKS = {
  mensal: {
    cartao: 'https://checkout.wiven.com.br/checkout/cmqhil5uf00uk01pkrfkcg47g?code=kf0pe9e&offer=9FP58KU',
    pix: 'https://go.ironpayapp.com.br/knwcyeiala?affh=ugs8hqxbzi',
  },
  vitalicio: {
    cartao: 'https://checkout.wiven.com.br/checkout/cmqhil5uf00uk01pkrfkcg47g?code=kf0pe9e&offer=YO807KG',
    pix: 'https://go.ironpayapp.com.br/paqjh?affh=tp145wlwm2',
  },
} as const;
        ...
        <div style={{ display: "flex", flexWrap: "wrap", gap: 32, justifyContent: "space-between", alignItems: "flex-start", marginBottom: 40 }}>
          <div>
            <div style={{ display: "flex", alignItems: "center", gap: 9, marginBottom: 10 }}>
              <img src="/brand/logo.png" alt="UpShopee" style={{ height: 38, objectFit: "contain" }} onError={(e) => { (e.currentTarget as HTMLImageElement).style.display = "none"; }} />
