/*
  ...
  Checkouts COM `code=uqc310u` — é esse parâmetro que credita a
...
const CONFIG: Ofertas5LandingConfig = {
  checkouts: {
    mensal:
      "https://checkout.applyfy.com.br/checkout/cmrc5aowy0s7y01ol3jfeb4he?code=uqc310u&offer=Q7TO6PU",
    vitalicio:
      "https://checkout.applyfy.com.br/checkout/cmrc5aowy0s7y01ol3jfeb4he?code=uqc310u&offer=4XWIBWR",
  },
};

export const Route = createFileRoute("/ofertas10")({
