...
export const Route = createFileRoute("/planos2")({ component: PlanosPage });
...
const LINKS = {
  mensal: {
    cartao: 'https://go.perfectpay.com.br/PPU38CQD4TD',
    pix: 'https://go.ironpayapp.com.br/jxzfsyhoci?affh=rqmwr5cri2',
  },
  vitalicio: {
    cartao: 'https://go.perfectpay.com.br/PPU38CQD4TF',
    pix: 'https://go.ironpayapp.com.br/knwcyeiala?affh=tvfmkg2pt1',
  },
} as const;
  ...
  return (
    <section className="py-20 bg-[#080808] relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 text-center relative z-10 max-w-2xl">
        ...
        <a
          href="https://go.ironpayapp.com.br/knwcyeiala?affh=tvfmkg2pt1"
