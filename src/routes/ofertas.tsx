/*
  ═══════════════════════════════════════════════════════════════
  UPSHOPEE — /ofertas  (conversão 1:1 do index.html original)
  ═══════════════════════════════════════════════════════════════
  • Links de checkout: JÁ PREENCHIDOS (consts abaixo)
  • Logo: /brand/logo.png (garanta o arquivo em public/brand/)
  • Fontes Sora/Inter: injetadas automaticamente no <head>
  • Vídeo VSL: pendente — procure "VSL_VIDEO" no JSX (snippet pronto)
  • Contadores: procure "PLACEHOLDER-COUNTER" para trocar os números
  ═══════════════════════════════════════════════════════════════
*/
...
function OfertasPage() {
  ...
  useEffect(() => {
    ...
    /* mobile: back-button intent (obs.: convive com o history do router — mostra o popup no 1º "voltar" e libera no 2º) */
