/*
  ...
  Checkouts COM `code=uwgmhfh` — é esse parâmetro que credita a
...
const CONFIG: Ofertas5LandingConfig = {
  checkouts: {
    mensal:
      "https://checkout.applyfy.com.br/checkout/cmrc5aowy0s7y01ol3jfeb4he?code=uwgmhfh&offer=Q7TO6PU",
    vitalicio:
      "https://checkout.applyfy.com.br/checkout/cmrc5aowy0s7y01ol3jfeb4he?code=uwgmhfh&offer=4XWIBWR",
  },
};

export const Route = createFileRoute("/ofertas11")({
