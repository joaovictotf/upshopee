/*
  ...
  Checkouts COM `code=di54wop` — é esse parâmetro que credita a
...
const CONFIG: Ofertas5LandingConfig = {
  checkouts: {
    mensal:
      "https://checkout.applyfy.com.br/checkout/cmrc5aowy0s7y01ol3jfeb4he?code=di54wop&offer=Q7TO6PU",
    vitalicio:
      "https://checkout.applyfy.com.br/checkout/cmrc5aowy0s7y01ol3jfeb4he?code=di54wop&offer=4XWIBWR",
  },
};

export const Route = createFileRoute("/ofertas9")({
