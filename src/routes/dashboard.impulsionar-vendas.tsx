...
// O tipo do estado do PIX mora junto do modal compartilhado
// (src/components/PixQrModal.tsx), usado também pela página de aulas.
type QrState = PixQrState;
    ...
    return (
      <>
        ...
        {qrState.status !== "idle" && (
          <PixQrModal
            qrState={qrState}
            item={paymentPack ? { name: paymentPack.name, amount: paymentPack.price } : null}
            itemLabel="Pacote"
            footerNote={<>Após o pagamento, seu anúncio será <strong>ativado automaticamente</strong>.</>}
