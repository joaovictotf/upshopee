/**
 * WhatsAppSupportButton — Botão global de suporte via WhatsApp.
 *
 * Para alterar o número/mensagem, edite apenas WHATSAPP_SUPPORT_URL abaixo.
 */
...
export function WhatsAppSupportButton() {
  return (
    ...
    >
      <WhatsAppIcon className="whatsapp-support-icon" />
      {/* Texto visível apenas em telas maiores */}
      <span className="whatsapp-support-label">Suporte WhatsApp</span>
    </a>
  );
}
