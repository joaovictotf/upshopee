...
function LogoArea() {
  return (
    <div className="flex items-center gap-2">
      <img src="/brand/logo.png" alt="UpShopee" className="h-11 w-auto object-contain drop-shadow-sm" onError={(e) => { (e.currentTarget as HTMLImageElement).style.display = "none"; }} />
